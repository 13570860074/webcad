...
void GeLine3d::getInterval(GeInterval& range) const
{
	range.set();
}

void GeLine3d::getInterval(GeInterval& range, GePoint3d& startPoint, GePoint3d& endPoint) const
{
	range.set();
...
{
	GeLine3d* line = new GeLine3d(*this);
