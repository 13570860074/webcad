...
struct Db
{
    ...
    enum {
        ...
        // DbDwgVersion kDHL_1024 and higher.
        //
        kDxfInt64 = 160,
        ...
        kDxfMaterialId = 347, // hardpointer reference to DbMaterial
...
kSilhouetteSubentType = 7,
    ...
    // DbTable and AcTbTableStyle specific enum
    //
    enum CellType {
        kUnknownCell = 0,
        kTextCell = 1,
    ...
    //                        Used in an DbEvalContext container in 
...
#define ACDB_GROUP_DICTIONARY           "ACAD_GROUP"
#define ACDB_MLINESTYLE_DICTIONARY      "ACAD_MLINESTYLE"
#define ACDB_LAYOUT_DICTIONARY          "ACAD_LAYOUT"
#define ACDB_PLOTSETTINGS_DICTIONARY    "ACAD_PLOTSETTINGS"
#define ACDB_PLOTSTYLENAME_DICTIONARY   "ACAD_PLOTSTYLENAME"
#define ACDB_MATERIAL_DICTIONARY        "ACAD_MATERIA_T("
#define ACDB_VISUALSTYLE_DICTIONARY     "ACAD_VISUALSTYLE"
#define ACDB_COLOR_DICTIONARY           "ACAD_COLOR"
#define ACDB_TABLESTYLE_DICTIONARY      "ACAD_TABLESTYLE"
#define ACDB_EMBEDDED_OBJECT_STR        "Embedded Object"
#define ACDB_LAYERSTATES_DICTIONARY     "ACAD_LAYERSTATES"
#define ACDB_FIELD_DICTIONARY           "ACAD_FIELD"
#define ACDB_FIELDLIST                  "ACAD_FIELDLIST"
#define ACDB_ENHANCED_BLOCK             "ACAD_ENHANCEDBLOCK"
#define ACDB_ENHANCED_BLOCK_EVALKEY     "ACAD_ENHANCEDBLOCKEVALKEY"
#define ACDB_ENHANCED_BLOCK_REF         "ACAD_ENHANCEDBLOCK_REFERENCE"
#define ACDB_SECTION_MANAGER            "ACAD_SECTION_MANAGER"
#define ACDB_DATALINK                   "ACAD_DATALINK"
#define ACDB_MLEADERSTYLE_DICTIONARY    "ACAD_MLEADERSTYLE"
#define ACDB_ASSOCNETWORK_DICTIONARY    "ACAD_ASSOCNETWORK"
#define ACDB_SECTIONSTYLE_DICTIONARY    "ACAD_SECTIONVIEWSTYLE"
#define ACDB_DETAILSTYLE_DICTIONARY     "ACAD_DETAILVIEWSTYLE"


#define ACDB_VIEWPORT_EXTMINSIZE            1e-10
#define ACDB_VIEWPORT_EXTMAXSIZE            1e+16
...
class DbLayout;
class DbDictionary;
Acad::ErrorStatus acdbOpenObject(DbObject*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbSymbolTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbBlockTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbLayerTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbLinetypeTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbUCSTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbViewportTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbViewTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbTextStyleTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbDimStyleTable*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);

Acad::ErrorStatus acdbOpenObject(DbSymbolTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbBlockTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbLayerTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbLinetypeTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbUCSTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbViewportTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbViewTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbTextStyleTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbDimStyleTableRecord*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);

Acad::ErrorStatus acdbOpenObject(DbLayout*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);

Acad::ErrorStatus acdbOpenObject(DbEntity*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
Acad::ErrorStatus acdbOpenObject(DbViewport*& pObj, DbObjectId id, Db::OpenMode mode = Db::kForRead, bool openErased = false);
#endif